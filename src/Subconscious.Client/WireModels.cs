...
/// <summary>Empty request body used when creating a workspace-relative directory.</summary>
public sealed record CreateWorkspaceDirectoryRequest;
...
public sealed record ToolRegistry
{
    ...
    [JsonPropertyName("hasAuthConfig")] public bool HasAuthConfig { get; init; }
...
public sealed record UpsertToolRegistryRequest
{
    ...
    [JsonPropertyName("endpointUrl")] public string? EndpointUrl { get; init; }
    [JsonPropertyName("authType")] public string? AuthType { get; init; }
    [JsonPropertyName("authConfigJson")] public string? AuthConfigJson { get; init; }
    [JsonPropertyName("clearAuthConfig")] public bool ClearAuthConfig { get; init; }
    [JsonPropertyName("status")] public string? Status { get; init; }
}
