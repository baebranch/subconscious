...
class Chat(Base):
  ...
  def __repr__(self):
    return f'Chat(id={self.id!r}, workspace_id={self.workspace_id!r}, title={self.title!r}, description={self.description!r}, meta={self.meta!r}, updated_at={self.updated_at!r}, created_at={self.created_at!r})'
